...
Característica: Modificar datos del docente
  ...
  Escenario: : Modificar datos del docente exitoso
    ...
    Y existe un docente
    Cuando modifica un docente con "número de matrícula", "DNI", "apellido", "nombre", "dirección", "teléfonos", "fecha de nacimiento", "fecha de ingreso", "fecha de egreso", "categoria" y "titulos"
