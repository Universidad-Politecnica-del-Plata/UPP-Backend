...
Característica: Dar de baja plan de estudios
  ...
  Escenario: Dar de baja plan de estudios con materias fracasa por validación
  ...
  Escenario: Dar de baja plan de estudios sin materias es exitoso
    Dado se registra un nuevo plan de estudios con codigo "P2-VACIO", fecha de entrada en vigencia "01-01-2025", fecha de vencimiento "31-12-2035", sin materias y total de créditos optativos 20
    Cuando se da de baja el plan de estudios con codigo "P2-VACIO"
    Entonces no existe el plan de estudios "P2-VACIO" en el registro
