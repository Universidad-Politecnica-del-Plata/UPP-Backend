...
#Como responsable de Logística y Mantenimiento quiero modificar datos de un aula para garantizar la exactitud de la información sobre las instalaciones de la sede
