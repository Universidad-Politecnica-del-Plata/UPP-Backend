...
class InscripcionServiceTest {
  ...
  void eliminarInscripcionNoExisteLanzaExcepcion() {
    ...
    assertThrows(
        InscripcionNoExisteException.class, () -> inscripcionService.eliminarInscripcion(1L));
  ...
  void obtenerInscripcionPorCodigoNoExisteLanzaExcepcion() {
    ...
    assertThrows(
        InscripcionNoExisteException.class,
  ...
  void crearInscripcionFueraDePeriodoTempranoLanzaExcepcion() {
    Cuatrimestre cuatrimestreFuturo =
        new Cuatrimestre(
            "2024-2",
  ...
  void crearInscripcionFueraDePeriodoTardeLanzaExcepcion() {
    Cuatrimestre cuatrimestrePasado =
        new Cuatrimestre(
            "2023-2",
