...
public class modificar_datos_de_cuatrimestre_steps {
  ...
  @Cuando("se modifica el cuatrimestre con código {string}, fecha de inicio de clases {string}, fecha de fin de clases {string}, fecha de inicio de inscripción {string}, fecha de fin de inscripción {string}, fecha de inicio de integradores {string}, fecha de fin de integradores {string} y los cursos {string}")
  public void seModificaElCuatrimestreConCursos(String codigo, String fechaInicioClases, String fechaFinClases, 
      String fechaInicioInscripcion, String fechaFinInscripcion, String fechaInicioIntegradores, String fechaFinIntegradores, String cursos) {
  ...
  @Cuando("se modifica el cuatrimestre con código {string}, fecha de inicio de clases {string}, fecha de fin de clases {string}, fecha de inicio de inscripción {string}, fecha de fin de inscripción {string}, fecha de inicio de integradores {string}, fecha de fin de integradores {string} y sin cursos")
  public void seModificaElCuatrimestreSinCursos(String codigo, String fechaInicioClases, String fechaFinClases, 
      String fechaInicioInscripcion, String fechaFinInscripcion, String fechaInicioIntegradores, String fechaFinIntegradores) {
  ...
  public void queElCuatrimestreTieneAsociadosLosCursos(String codigoCuatrimestre, String cursos) {
    ...
    CuatrimestreDTO cuatrimestreConCursos = new CuatrimestreDTO(
  ...
  public void elCuatrimestreTieneLosCursos(String codigoCuatrimestre, String cursosEsperados) {
    ...
    List<String> cursosEsperadosList = Arrays.stream(cursosEsperados.split(","))
        .map(String::trim)
        .collect(Collectors.toList());

    assertNotNull(cuatrimestre.getCodigosCursos());
    assertTrue(cuatrimestre.getCodigosCursos().containsAll(cursosEsperadosList),
        "El cuatrimestre no contiene todos los cursos esperados. Esperados: " + cursosEsperadosList + 
        ", Actuales: " + cuatrimestre.getCodigosCursos());
  }
  ...
  public void elCuatrimestreNoTieneElCurso(String codigoCuatrimestre, String codigoCurso) {
    ...
    if (cuatrimestre.getCodigosCursos() != null) {
      assertTrue(!cuatrimestre.getCodigosCursos().contains(codigoCurso),
  ...
  public void elCuatrimestreNoTieneCursosAsociados(String codigoCuatrimestre) {
    ...
    assertTrue(cuatrimestre.getCodigosCursos() == null || cuatrimestre.getCodigosCursos().isEmpty(),
