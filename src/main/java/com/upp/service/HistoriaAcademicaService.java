...
/**
 * Consulta la historia académica de un alumno: materias aprobadas, créditos acumulados,
 * y si cumple los requisitos para inscribirse a una materia (créditos y correlativas).
 */
@Service
