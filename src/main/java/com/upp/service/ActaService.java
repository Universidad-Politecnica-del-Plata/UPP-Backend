...
/**
 * Gestiona las actas de examen (parciales y finales). Permite crear actas, cargar notas (solo
 * aprobatorias 4-10), cerrar actas y consultar los alumnos inscriptos en cada curso.
 */
@Service
@Transactional
public class ActaService {
  ...
  public ActaDTO crearActa(ActaRequestDTO actaRequestDTO) {
    ...
    // No puede haber dos actas abiertas del mismo tipo para un curso
  ...
  public NotaDTO agregarNota(Long numeroCorrelativo, NotaRequestDTO notaRequestDTO) {
    ...
    // El alumno tiene que estar inscripto en el curso del cuatrimestre actual
    ...
    // Si ya tiene nota la actualizo, sino creo una nueva
  ...
  public List<AlumnoInscriptoDTO> obtenerAlumnosInscriptosPorActa(Long numeroCorrelativo) {
    ...
    // Busco el cuatrimestre en el que se creó el acta
