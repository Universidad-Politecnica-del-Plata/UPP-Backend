...
/**
 * Endpoints para consultar la historia académica de un alumno (materias aprobadas, créditos y si
 * esta habilitado para una inscripción en base a la historia.
 */
@RestController
